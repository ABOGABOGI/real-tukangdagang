...
public class RincianMakanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tampilHarga = (TextView) findViewById(R.id.tampil_harga_makanan);
        tampilAlamat = (TextView) findViewById(R.id.tampil_alamat_makanan);
        tampilKategori = (TextView) findViewById(R.id.tampil_kategori_makanan);
        tampilBerat = (TextView) findViewById(R.id.tampil_berat_makanan);
        tampilDeskripsi = (TextView) findViewById(R.id.tampil_deskripsi_makanan);
        img = (ImageView) findViewById(R.id.gambar_makanan);
